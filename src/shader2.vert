...
layout(location=1) out vec4 tri_Pos;
...
void main () {
  ...
  // Takes in the 4 floats, including the position of where the vertex is being stored
  ...
  // tri_Pos = vec4(positions[gl_VertexIndex], 0.0, 1.0);
  tri_Pos = gl_Position;
}
